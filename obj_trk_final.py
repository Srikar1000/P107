...
video = cv2.VideoCapture("C:/Users/pidik/Downloads/project-C107-template-main/project-C107-template-main/footvolleyball.mp4")
#load tracker 
...
def drawBox(img,bbox):
    ...
    cv2.putText(img,'Tracking', (75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,22),3)
while True:
   #Write the code inside loop here
    ...
    if success:
        ...
        cv2.putText(img,'Lost',(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(255,255,0),2)
